...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Patrimoni Arquitectonio Guanacaste</title>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/Patrimonio-Arquitectnico-nacional/Proyecto/css/style2.css" />
    ...
    <body id="page">
        <div class="container">
			...
			<header>
				<h1>Patrimonio Nacional <span>Costa Rica</span> guanacaste</h1>
