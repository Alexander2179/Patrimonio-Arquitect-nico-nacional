...
<html class="no-js" lang="en">
    <head>
        ...
        <title>liberia_Guanacaste</title>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/Patrimonio-Arquitectnico-nacional/Proyecto/css/style5.css" />
    ...
    <body id="page">
        <div class="container">
			...
			<header>
				<h1>esparza<span>Costa Rica</span> guanacaste</h1>
